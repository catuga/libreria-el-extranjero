    ...
    data: [
      {
        ...
        precio: 22.9,
        stock: 5,
        descripcion: "La historia de Kvothe, un legendario mago y músico narrada en primera persona.",
      ...
      },
      {
        ...
        precio: 19.9,
        stock: 8,
        descripcion: "La saga de la familia Buendía a lo largo de siete generaciones en Macondo.",
      ...
      },
      {
        ...
        precio: 21.5,
        stock: 3,
        descripcion: "Un joven descubre un libro misterioso en el Cementerio de los Libros Olvidados de Barcelona.",
